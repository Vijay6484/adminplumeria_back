    ...
    try {
        ...
        try {
            ...
            const updateData = {
                ...
                MaxPersonVilla: validateInput(basicInfo.MaxPersonVilla ?? current.MaxPersonVilla, 'number',true),
                RatePersonVilla: validateInput(basicInfo.RatePersonVilla ?? current.RatePersonVilla, 'number',true),
